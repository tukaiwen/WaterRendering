...
public class ShallowWater : MonoBehaviour
{
    ...
    private int csShallowWaterKernel;
    ...
    private void OnEnable()
    {
        ...
        csShallowWaterKernel = shallowWaterComputeShader.FindKernel("ShallowWater");
    ...
    private void LateUpdate()
    {
        ...
        if (coreCameraTrans != null)
        {
            ...
            if (shallowCameraMoved)
            {
                ...
                cmdBuffer.SetComputeBufferParam(shallowWaterComputeShader, csUpdateBufferKernel, "CurrentBuffer", current);
                cmdBuffer.SetComputeBufferParam(shallowWaterComputeShader, csUpdateBufferKernel, "PrevBuffer", pre);
                cmdBuffer.SetComputeBufferParam(shallowWaterComputeShader, csUpdateBufferKernel, "PrevPrevBuffer", prepre);
                ...
                cmdBuffer.SetComputeBufferParam(shallowWaterComputeShader, csUpdateBufferKernel, "NewCurrentBuffer", current);
                cmdBuffer.SetComputeBufferParam(shallowWaterComputeShader, csUpdateBufferKernel, "NewPrevBuffer", pre);
                cmdBuffer.SetComputeBufferParam(shallowWaterComputeShader, csUpdateBufferKernel, "NewPrevPrevBuffer", prepre);

                cmdBuffer.DispatchCompute(shallowWaterComputeShader, csUpdateBufferKernel, HeightMapSize / 8 + 1, HeightMapSize / 8 + 1, 1);
            ...
            cmdBuffer.SetComputeTextureParam(shallowWaterComputeShader, csShallowWaterKernel, "_ShallowObjDepthTexture", ObjDepthRenderTexture);
            if (NeedBoundRenderers)
            {
                cmdBuffer.SetComputeTextureParam(shallowWaterComputeShader, csShallowWaterKernel, "_ShallowBoundDepthTexture", BoundDepthRenderTexture);
            }
            cmdBuffer.SetComputeBufferParam(shallowWaterComputeShader, csShallowWaterKernel, "CurrentBuffer", current);
            cmdBuffer.SetComputeBufferParam(shallowWaterComputeShader, csShallowWaterKernel, "PrevBuffer", pre);
            cmdBuffer.SetComputeBufferParam(shallowWaterComputeShader, csShallowWaterKernel, "PrevPrevBuffer", prepre);
            cmdBuffer.SetComputeTextureParam(shallowWaterComputeShader, csShallowWaterKernel, "_ShallowWaterHeightRT", ShallowWaterHeightRT);

            cmdBuffer.DispatchCompute(shallowWaterComputeShader, csShallowWaterKernel, HeightMapSize / 8 + 1, HeightMapSize / 8 + 1, 1);
